...
export let Project_data = [
 {
  ...
  },
  {
    ...
    initiallyHidden: false,
    thumb: jetbite,
    thumbAlt: 'Food Delivery web Appt',
    href: 'https://jet-bite.vercel.app/',
    title: 'Weather Forecast Web App',
    github: { href: 'https://github.com/Sa-ran23/JetBite', text: 'GitHub', icon: true },
    text: 'Built a responsive food delivery web application that integrates REST APIs to fetch real-time restaurant and menu data, with restaurant browsing, cart management, and a seamless user experience.',
    stack: 'React • Tailwind • JS • REST API',
  },
  {
    id: 4,
